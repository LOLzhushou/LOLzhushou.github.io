(function() {
    ...
    function N(a, b, d) {
        ...
        if (!F) {
            ...
            null == a.$scrollBehavior && fa(a) && (a.$scrollBehavior = a.style.scrollBehavior,
            ...
            var g = function(c) {
                ...
                for (var k = 0, l = 0, h = 0; h < t.length; h++) {
                    ...
                    1 <= p ? q = 1 : 0 >= p ? q = 0 : (1 == f.pulseNormalize && (f.pulseNormalize /= P(1)),
                    q = P(p)));
                    p = n.x * q - n.lastX >> 0;
                    q = n.y * q - n.lastY >> 0;
                    k += p;
                ...
                l && (a.scrollTop += l));
                b || d || (t = []);
                t.length ? Q(g, a, 1E3 / f.frameRate + 1) : (F = !1,
                null != a.$scrollBehavior && (a.style.scrollBehavior = a.$scrollBehavior,
    ...
    function R(a) {
        ...
        ha && (a.wheelDeltaX && x(a.wheelDeltaX, 120) && (d = a.wheelDeltaX / Math.abs(a.wheelDeltaX) * -120),
        ...
        b = S(b);
        if (!b)
            return v && G ? (Object.defineProperty(a, "target", {
    ...
    function M(a) {
        ...
        if (c || b.isContentEditable || d || (r(b, "button") || r(b, "input") && e.test(b.type)) && a.keyCode === g.spacebar || r(b, "input") && "radio" == b.type && ja[a.keyCode])
            return !0;
        c = b = 0;
        d = S(m);
        if (!d)
            return v && G ? parent.keydown(a) : !0;
        e = d.clientHeight;
        ...
        do {
            ...
            if (c === a.scrollHeight) {
                ...
                v && l.clientHeight + 10 < l.scrollHeight || !v && e)
                    return I(b, O())
            } else if (a.clientHeight + 10 < a.scrollHeight && Y(a))
                return I(b, a)
    ...
    function fa(a) {
        var b = J(a);
        null == A[b] && (a = getComputedStyle(a, "")["scroll-behavior"],
        A[b] = "smooth" == a);
        return A[b]
    }
    function r(a, b) {
    ...
    var aa = {
        ...
        x: 0,
        y: 0
    }, D = !1, l = document.documentElement, m, z, w, h = [], Z, ha = /^Mac/.test(navigator.platform), g = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    L && k && (window.addEventListener(L, R, u || !1),
